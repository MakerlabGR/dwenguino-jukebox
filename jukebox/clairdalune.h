...
const byte ledPin = ledpin2;
const byte speakerOut = A5; /* This makes a standard old PC speaker connector fit nicely over the pins. */
...
/* our song5. Each number pair is a MIDI note and a note symbol. */
...
const unsigned int MAXCOUNT = sizeof(song5) / 2;
